...
abstract class AbstractCase {
	...
	/**
	 * @param \TYPO3\Docs\Finder\Uri\AbstractCase $nextCase
	 * @return void
	 */
	public function setSuccessor(\TYPO3\Docs\Finder\Uri\AbstractCase $nextCase) {
	 ...
	 * @return string
	 */
	protected function proceed(\TYPO3\Docs\Domain\Model\Package $package) {
	 ...
	 * @return string
	 */
	abstract public function handle(\TYPO3\Docs\Domain\Model\Package $package);
}
