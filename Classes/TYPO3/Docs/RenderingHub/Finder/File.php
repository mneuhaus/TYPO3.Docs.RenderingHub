...
class File {
	 ...
	 */
	public function getRemoteFile(\TYPO3\Docs\RenderingHub\Domain\Model\Document $document) {
	 ...
	 * @return string path name with the file name append
	 */
	public function getExtensionFileNameAndPath(\TYPO3\Docs\RenderingHub\Domain\Model\Document $document) {
	 ...
	 */
	public function getExtensionFileNameAndSubPath(\TYPO3\Docs\RenderingHub\Domain\Model\Package $package) {
