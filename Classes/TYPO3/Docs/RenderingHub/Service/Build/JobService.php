<?php
namespace TYPO3\Docs\RenderingHub\Service\Build;
...
class JobService {
	...
	/**
	 * Create a job for rendering the documentation.
	 *
	 ...
	 */
	public function create(\TYPO3\Docs\RenderingHub\Domain\Model\Document $document) {

		// Computes formats
		$className = sprintf('\TYPO3\Docs\RenderingHub\Job\Build\%sDocumentJob', ucfirst($document->getRepositoryType()));
