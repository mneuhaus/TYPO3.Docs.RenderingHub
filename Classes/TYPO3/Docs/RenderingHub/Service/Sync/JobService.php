<?php
namespace TYPO3\Docs\RenderingHub\Service\Sync;
...
class JobService {
	 ...
	 * @return \TYPO3\Docs\RenderingHub\Job\Sync\DocumentJob
	 */
	public function create($packageKey) {
		$job = new \TYPO3\Docs\RenderingHub\Job\Sync\DocumentJob($packageKey);
